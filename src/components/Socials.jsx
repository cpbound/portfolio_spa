      ...
      <div className="contactText">
        ...
        >
          ...
          <div className="socialsLinks">
            <a target="_blank" rel="noreferrer" href="https://www.linkedin.com/in/christian-bound/">
              <FaLinkedin className="socialIcon" />
              <span className="tooltiptext">LinkedIn</span>
            </a>
            <a target="_blank" rel="noreferrer" href="https://github.com/cpbound">
              <FaGithubAlt className="socialIcon" />
              <span className="tooltiptext">GitHub</span>
            </a>
            <a target="_blank" rel="noreferrer" href="https://medium.com/@cpbound87">
              <FaMediumM className="socialIcon" />
              <span className="tooltiptext">Medium</span>
            </a>
            <a target="_blank" rel="noreferrer" href="https://soundcloud.com/adult_time">
              <FaSoundcloud className="socialIcon" />
              <span className="tooltiptext">Soundcloud</span>
            </a>
            <a target="_blank" rel="noreferrer" href="https://adulttime.bandcamp.com/">
              <FaBandcamp className="socialIcon" />
              <span className="tooltiptext">Bandcamp</span>
            </a>
            <a target="_blank" rel="noreferrer" href="mailto:cpbound87@gmail.com">
        ...
        <div className="footer">
          <div className="footerText">
            ...
            <a target="_blank" rel="noreferrer" href="https://actselect.chips.jp/">
